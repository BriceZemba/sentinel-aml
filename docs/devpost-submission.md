...
4. README must contain (it does): project description, UiPath components, agent
   type (coded + low-code), setup instructions, coding-agent usage. ✔️
...
## Step 5 Coding-agent bonus (do not skip  up to +2 points)
...
git branch -M main
git remote add origin https://github.com/<BriceZEMBA>/sentinel-aml.git
